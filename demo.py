...
def get_args():
    ...
    parser.add_argument('--project_name', default='test1011_1', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='checkpoint_test1011_1', type=str)
    parser.add_argument('--output_folder', default='../BIT_data2/predict_test1011_1', type=str)
...
# 测试集中是否要输出F1_score等性能指标？
# 最后验收时是只需输出预测结果的阈值图片嘛？
    args = get_args()
